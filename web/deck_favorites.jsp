...
<div <%=welled%>>
    <div class="col-xs-12">
        <div class="col-xs-12">
            <h2>Favorites: Decks</h2><br>
            <h4>
                <p>Below are your favorited decks. You may choose to view a deck's information page by clicking the "View" link. You may remove the deck from your favorites by clicking the start button.</p>
                <br>
            </h4>
        </div>
        <div class="col-xs-12">
