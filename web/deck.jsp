        ...
        <div class="col-xs-12">
            <%
                ...
                if(parent == null || parent.equals("")) {
                    ...
                    parent = (deckInfo.getDeckById(parent)).getName();
                }
            ...
            <div class="col-xs-12 col-sm-4">
                <h4>
                    ...
                    <div class="row" style="margin: auto;display: table">
                        <div class="col-xs-4" style="margin: auto;display: table" id="button-back-left" title="View Deck Information" onclick="document.getElementById('viewForm').submit();">
                            <span id="button-symbol" class="glyphicon glyphicon-eye-open"></span>
                        </div>
                        <div class="col-xs-4" style="margin: auto;display: table" id="button-back-middle" title="Edit Deck" onclick="document.getElementById('editForm').submit();">
