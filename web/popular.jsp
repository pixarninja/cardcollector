...
<jsp:useBean id="popularGame" class="beans.PopularGame" scope="request"/>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                    <%
                        int rank = 1;
                        while(rank <= 50) {
                            PopularGame game = (PopularGame) popularGame.getGame(rank);
                            if(game == null) {
                                %>Something horribly, horribly, horribly wrong happened...<%
                                break;
                            }
                    %>
                    <tr>
