            ...
            <h4>
                ...
                <div class="col-xs-6">
                    <form id="requestLessForm" action="SearchServlet" method="POST">
                        ...
                        <input id="form-submit" type="submit" value="Previous 100 Collections">
                      </form>
                </div>
                <%}%>
                <%
                ...
                <div class="col-xs-6">
                    <form id="requestMoreForm" action="SearchServlet" method="POST">
                        ...
                        <input type="hidden" name="min-score" value="<%=request.getParameter("min-score")%>">
                        <input type="hidden" name="max-score" value="<%=request.getParameter("max-score")%>">
                        <input id="form-submit" type="submit" value="Next 100 Collections">
                    </form>
                </div>
                <%}%>
                <h4>
                    <div class="row">
                        <div class="col-xs-6 col-sm-3 col-md-2">
                            <p align="center">Collection Name</p>
                            <br>
                            <div class="deck-image">
                                <div class="collection-image">
                                    <img class="collect-back" width="100%" src="<%=backgroundImage%>" alt="<%=backgroundImage%>" id="center-img"></img>
                                    <img class="collect-mid-alt" width="100%" src="<%=midgroundImage%>" alt="<%=midgroundImage%>" id="center-img"></img>
                            ...
                            <form id="collectionForm" action="CollectionServlet" method="POST">
                                ...
                                <input type="hidden" name="username" value="<%=username%>">
                                <button title="View Collection Information" id="alt-submit" type="submit"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;&nbsp;View</button>
                            </form>
