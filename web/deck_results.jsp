        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-4">
                ...
                <form id="requestLessForm" action="SearchServlet" method="POST">
                    ...
                    <button title="Previous <%=max%> Decks" id="form-submit" type="submit"><span class="glyphicon glyphicon-menu-left"></span>&nbsp;&nbsp;Previous <%=max%></button>
                </form>
                <div class="col-xs-12"><br></div>
            </div>
            <%
            ...
            <div class="col-xs-4">
                ...
                <form id="requestMoreForm" action="SearchServlet" method="POST">
                    ...
                    %>
                    <input type="hidden" name="username" value="<%=username%>">
                    <button title="Next <%=max%> Decks" id="form-submit" type="submit">Next <%=max%>&nbsp;&nbsp;<span class="glyphicon glyphicon-menu-right"></span></button>
                </form>
                <div class="col-xs-12"><br></div>
            </div>
            <%
